import sys
import os
sys.path.append(os.path.dirname('/home/yuki/research/EDiffSR_combine_DifGaussian/external/galerkin_transformer')) 
try:
    from layers import *
...
class SimpleTransformerEncorderOnly(nn.Module):
    def __init__(self, **kwargs):
        super(SimpleTransformerEncorderOnly, self).__init__()
        self.config = defaultdict(lambda: None, **kwargs)
        self._get_setting()
        self._initialize()
        self.__name__ = self.attention_type.capitalize() + 'Transformer'
